...
export const GET_CLIENT_SCOPES = 'GET_CLIENT_SCOPES'
export const GET_CLIENT_SCOPES_RESPONSE = 'GET_CLIENT_SCOPES_RESPONSE'
...
export const DELETE_AGAMA = 'DELETE_AGAMA'
export const ADD_AGAMA = 'ADD_AGAMA'
export const ADD_AGAMA_RESPONSE = 'ADD_AGAMA_RESPONSE'

// Authn
export const GET_DEFAULT_AUTHN = 'GET_DEFAULT_AUTHN'
export const SET_SQL = 'SET_SQL'
export const PUT_SIMPLE_AUTH_ACR = 'PUT_SIMPLE_AUTH_ACR'
export const PUT_LDAP_AUTH_ACR = 'PUT_LDAP_AUTH_ACR'
export const PUT_SCRIPT_ACR = 'PUT_SCRIPT_ACR'
export const SET_SIMPLE_AUTH_ACR_RESPONSE = 'SET_SIMPLE_AUTH_ACR_RESPONSE'
export const SET_LDAP_AUTH_ACR_RESPONSE = 'SET_LDAP_AUTH_ACR_RESPONSE'
export const SET_SCRIPT_ACR_RESPONSE = 'SET_SCRIPT_ACR_RESPONSE'
