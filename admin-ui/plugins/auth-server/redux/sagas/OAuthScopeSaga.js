...
import { triggerScopeWebhook } from 'Plugins/admin/redux/sagas/WebhookSagaUtils'
...
export function* addAScope({ payload }) {
  ...
  try {
    ...
    yield call(postUserAction, audit)
    yield* triggerScopeWebhook({ payload: { createdFeatureValue: data } })
    return data
  } catch (e) {
