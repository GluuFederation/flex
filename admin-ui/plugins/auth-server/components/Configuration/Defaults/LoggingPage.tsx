            ...
            >
              {(formik) => (
                <Form onSubmit={formik.handleSubmit}>
                  <style>{`
                    .logging-labels-black label,
                    .logging-labels-black label h5,
                    .logging-labels-black label span,
                    .logging-labels-black .MuiSvgIcon-root { color: ${customColors.black} !important; }
                  `}</style>
                  <div className="logging-labels-black">
                    <FormGroup row>
                      <GluuLabel
