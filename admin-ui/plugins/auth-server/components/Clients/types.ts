...
import type { Client, Scope, TokenEntity } from 'JansConfigApi'
...
/**
 * The form values shape used by the Client wizard. Typed loosely as JsonObject
 * because the underlying Gluu form helpers (GluuInputRow, GluuTypeAhead*, etc.)
 * are typed for FormikProps<JsonObject>. The actual runtime shape is a Client.
 */
export type ClientFormValues = JsonObject

export type ClientPanelFormik = FormikProps<ClientFormValues>
