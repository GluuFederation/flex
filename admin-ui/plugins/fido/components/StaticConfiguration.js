      ...
      <FormGroup row>
        <Col sm={8}>
          <GluuInputRow
            ...
            rsize={8}
            showError={
              formik.errors.authenticatorCertsFolder &&
              formik.touched.authenticatorCertsFolder
            }
        ...
        <Col sm={8}>
          <GluuInputRow
            ...
            rsize={8}
            showError={
              formik.errors.mdsAccessToken && formik.touched.mdsAccessToken
            }
        ...
        <Col sm={8}>
          <GluuInputRow
            ...
            rsize={8}
            showError={
              formik.errors.mdsCertsFolder && formik.touched.mdsCertsFolder
            }
        ...
        <Col sm={8}>
          <GluuInputRow
            ...
            rsize={8}
            showError={
              formik.errors.mdsTocsFolder && formik.touched.mdsTocsFolder
            }
        ...
        <Col sm={8}>
          <GluuSelectRow
            ...
            rsize={8}
            showError={
              formik.errors.checkU2fAttestations &&
              formik.touched.checkU2fAttestations
            }
        ...
        <Col sm={8}>
          <GluuInputRow
            ...
            rsize={8}
            showError={
              formik.errors.serverMetadataFolder &&
              formik.touched.serverMetadataFolder
            }
        ...
        <Col sm={8}>
          <GluuSelectRow
            ...
            rsize={8}
            showError={
              formik.errors.userAutoEnrollment &&
              formik.touched.userAutoEnrollment
            }
