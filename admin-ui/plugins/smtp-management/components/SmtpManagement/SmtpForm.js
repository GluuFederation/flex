...
function SmtpForm({ item, handleSubmit }) {
  ...
  const initialValues = {
    ...
    smtp_authentication_account_username:
      item?.smtp_authentication_account_username || '',
    smtp_authentication_account_password:
      item?.smtp_authentication_account_password || '',
  ...
  const formik = useFormik({
    ...
    validationSchema: Yup.object({
      ...
      requires_authentication: Yup.string()
        .min(2, 'Connection Protection is required.')
        .required('Authentication is required.'),
      smtp_authentication_account_username: Yup.string().required(
        'SMTP user name is required.',
      ),
      smtp_authentication_account_password: Yup.string().required(
        'SMTP user password is required.',
      ),
      trust_host: Yup.string()
        .min(2, 'Connection Protection is required.')
        .required('Trust host is required.'),
    }),
    setFieldValue: (field) => {
      delete values[field]
    },
      ...
      <FormGroup row>
        ...
        <Col sm={8}>
          <GluuSelectRow
            ...
            rsize={9}
            showError={
              formik.errors.connect_protection &&
              formik.touched.connect_protection
            }
        ...
        <Col sm={8}>
          <GluuInputRow
            ...
            rsize={9}
            showError={
              formik.errors.from_email_address &&
              formik.touched.from_email_address
            }
        ...
        <Col sm={8}>
          <GluuSelectRow
            ...
            rsize={9}
            showError={
              formik.errors.requires_authentication &&
              formik.touched.requires_authentication
            }
        ...
        <Col sm={8}>
          <GluuInputRow
            ...
            rsize={9}
            showError={
              formik.errors.key_store_password &&
              formik.touched.key_store_password
            }
        ...
        <Col sm={8}>
          <GluuInputRow
            ...
            rsize={9}
            showError={
              formik.errors.key_store_alias && formik.touched.key_store_alias
            }
        ...
        <Col sm={8}>
          <GluuInputRow
            ...
            rsize={9}
            showError={
              formik.errors.signing_algorithm &&
              formik.touched.signing_algorithm
            }
