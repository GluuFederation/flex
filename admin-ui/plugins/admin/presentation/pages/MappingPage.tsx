...
import MappingAddDialogForm from '../components/Mapping/MappingAddDialogForm'
import {
  Card,
  Col,
  CardBody,
...
import { getPermissions } from 'Plugins/admin/domain/redux/features/ApiPermissionSlice'
      ...
      <Card style={applicationStyle.mainCard}>
        <CardBody>
          <GluuViewWrapper canShow={hasPermission(permissions, MAPPING_READ)}>
            ...
            {mapping.map((candidate) => (
              <MappingItem key={candidate.role} candidate={candidate} roles={apiRoles} />
            ))}
          </GluuViewWrapper>
          <FormGroup row />
