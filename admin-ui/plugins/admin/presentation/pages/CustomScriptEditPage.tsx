...
import CustomScriptForm from '../components/CustomScripts/CustomScriptForm'
import { editCustomScript } from 'Plugins/admin/domain/redux/features/CustomScriptSlice'
  ...
  return (
    <GluuLoader blocking={loading}>
      ...
      <Card className="mb-3" style={applicationStyle.mainCard}>
        <CardBody>
          <CustomScriptForm
            item={{ ...item, moduleProperties: item?.moduleProperties && [...item.moduleProperties] }}
            scripts={scripts}
            viewOnly={viewOnly}
