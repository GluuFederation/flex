...
import { getSearchAblePermissions } from 'Plugins/admin/domain/useCases/MappingUseCases'
...
function MappingItem({ candidate, roles }) {
  ...
  const getPermissionsForSearch = () => {
    const filteredArr = getSearchAblePermissions(permissions, candidate.permissions)
          ...
          <Accordion className="mb-12">
            ...
            <Accordion.Body>
              ...
              {candidate.permissions.map((permission, id) => (
                <Row key={JSON.stringify(permission)}>
