...
const ContextNestedDropdownSubmenu: React.FC<
  Omit<NestedDropdownSubmenuProps, 'openId' | 'onOpen'> &
    Partial<Pick<NestedDropdownSubmenuProps, 'openId' | 'onOpen'>>
> = (props) => (
  <Consumer>
    {(contextProps: any) => <NestedDropdownSubmenu {...contextProps} {...props} />}
  </Consumer>
)
