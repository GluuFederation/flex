 ...
 * @param dateB - The second date (subtracted from dateA in result)
 * @param unit - Optional unit (e.g., 'millisecond', 'second', 'day')
 * @returns Difference in the given unit (default milliseconds)
 */
...
// Common format strings for reuse across the app
