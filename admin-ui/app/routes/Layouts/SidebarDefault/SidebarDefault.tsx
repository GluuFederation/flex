    ...
    <Container>
      ...
      <section className="mb-5">
        ...
        <ul className="ps-3">
          ...
          <li>
            <a href="https://gluu.org/flex" className="text-primary">Gluu Flex</a> - {t("based on the newest")} <i>Reactstrap</i>
          </li>
          <li>
      ...
      <section className="mb-5">
        ...
        <p>
          ...
          {t("Pleace contact us through the")} <a href="https://wbkom.co/contact" className="text-primary" target="_blank" rel="noopener noreferrer">webkom.co/contact</a> {t("website")}.
        </p>
      </section>
    </Container>
  )
