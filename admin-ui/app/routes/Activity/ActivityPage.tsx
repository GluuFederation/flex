      ...
      <Box display="flex" flexDirection={{ xs: 'column', md: 'row' }} gap="2rem">
        ...
        >
          <Box display="flex" flexDirection="row" gap=".5rem" alignItems="center">
            ...
            <Typography sx={{ color: themeColors.lightBackground }} variant="subtitle2">
              Daily
            </Typography>
          </Box>
          <Box display="flex" alignItems="baseline" justifyContent={'flex-start'} gap={'1.5rem'}>
            <Typography variant="h1" fontWeight={600}>
              27{' '}
            </Typography>
            <ArrowCircleUpIcon fontSize="large" width={'120px'} height={'120px'} />
          </Box>
      ...
      >
        ...
        <Box pl="16px" mt={'8px'} mb="16px" gap="8px" display="flex" justifyContent={'start'}>
          <Box display="flex" flexDirection={'column'}>
            <Typography variant="subtitle2" sx={{ color: themeColors.lightBackground }}>
              Sign-ups
            </Typography>
          ...
          <Divider
            sx={{ background: themeColors.lightBackground }}
