...
const GluuCommitDialogLegacy = ({
  ...
  const active = userMessage.length >= 10 && userMessage.length <= 512
...
GluuCommitDialogLegacy.propTypes = {
...
export default GluuCommitDialogLegacy
