            ...
            <div className={classes.statusText}>
              <Box display="flex" justifyContent="flex-start">
                ...
                <span>
                  <img 
                    ...
                    className={isUp(serverStatus) ? classes.iconCheck : classes.iconCross}
                    alt="oauth server" 
                  />
                </span>
              </Box>
              <Box display="flex" justifyContent="flex-end">
                <span className={classes.checkText}>
                  <span className={isUp(serverStatus) ? classes.checkText : classes.crossText}>
              ...
              <Box display="flex" justifyContent="flex-start">
                ...
                <span>
                  <img 
                    ...
                    className={isUp(dbStatus) ? classes.iconCheck : classes.iconCross}
                    alt="database" 
                  />
                </span>
              </Box>
              <Box display="flex" justifyContent="flex-end">
                <span className={isUp(dbStatus) ? classes.checkText : classes.crossText}>
        ...
        <div className={classes.root}>
          <Grid container className="px-40">
            <Grid item lg={5} md={12}>
              <h3 className="txt-white">Actives Users &amp; Access Token Stats</h3>
              <div className="mt-20">
            ...
            <Grid item lg={7} md={12} style={{ width: '100%' }}>
              <Paper className={`${classes.dashboardCard} top-minus-40`} elevation={0} spacing={2}>
                    ...
                    <Grid item xs={12} className={classes.flex}>
                      <Grid item md={4} xs={12} className="mt-20">
                        <Paper 
                          ...
                          elevation={3} 
                          style={isTabletOrMobile ? { paddingBottom: '10px' } : {}}
                        >
                      ...
                      <Grid item md={8} xs={12} className="mt-20">
                        <Paper className={classes.reports} elevation={3} style={isTabletOrMobile ? { display: 'block', textAlign:'center', paddingBottom: '10px' } : {}}>
                          <img src={DetailReport} alt="report" className={classes.detailReportImg} />
                          <div className={classes.reportTitle}>Detailed Reports</div>
                        </Paper>
                      </Grid>
                    </Grid>
                  </Grid>
                  <Grid item md={6} xs={isMobile ? 12 : 6} className={isMobile ? 'mt-20' : ''}>
                    <Paper className={classes.userInfo} style={isMobile ? { marginLeft: 0 } : {}} elevation={3}>
                        ...
                        {userInfo.map((info, key) => (
                          <div className={classes.userInfoText} key={key}>
                            ...
                            {info.text === 'License Status' ? (
                              <span className={info.value === 'active' ? classes.greenBlock : classes.redBlock}>
                                {info.value}
                              </span>
                            ) : (
                              <React.Fragment>
            ...
            <Grid lg={9} xs={12} className="top-minus-40">
              ...
              {isTabletOrMobile ? (
                <Grid container className={`${classes.whiteBg}`}>
                  ...
                  <Grid md={9} xs={12} style={isMobile ? mobileChartStyle : {}} item>
              ...
              <Grid item xs={12} className={classes.supportContainer}>
                ...
                <Paper className={`${classes.verticalTextContainer}`} style={{ background: themeColors.dashboard.supportCard }}>
                  <div style={{ zIndex: 4, display: 'flex', justifyContent: 'space-between' }}>
                    ...
                    <div className={`${classes.textVertical} text-right`}>SU<span className={`${classes.redText}`}>PP</span>ORT</div>
                  </div>
                </Paper>
              </Grid>
            </Grid>
