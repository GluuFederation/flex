...
export const GENERATE_TRIAL_LICENSE_KEY = 'GENERATE_TRIAL_LICENSE_KEY'
export const GENERATE_TRIAL_LICENSE_KEY_RESPONSE = 'GENERATE_TRIAL_LICENSE_KEY_RESPONSE'
export const ACTIVATE_CHECK_USER_LICENSE_KEY_RESPONSE =
  'ACTIVATE_CHECK_USER_LICENSE_KEY_RESPONSE'
export const ACTIVATE_CHECK_IS_CONFIG_VALID =
  'ACTIVATE_CHECK_IS_CONFIG_VALID'
export const ACTIVATE_CHECK_IS_CONFIG_VALID_RESPONSE =
  'ACTIVATE_CHECK_IS_CONFIG_VALID_RESPONSE'
export const UPLOAD_NEW_SSA_TOKEN =
  'UPLOAD_NEW_SSA_TOKEN'
export const UPLOAD_NEW_SSA_TOKEN_RESPONSE =
