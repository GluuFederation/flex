        ...
        <Col lg={ 6 }>
          ...
          <div className="mb-4">
            ...
            <Alert color="primary">
              ...
              <span> 
                <strong className="alert-heading">Welcome!</strong> Were glad to see you again and wish you a nice day.
              </span>
            </Alert>
          </div>
          { /* END Example */}
          ...
          <div className="mb-4">
            ...
            <Alert color="info">
              ...
              <span> 
                <strong className="alert-heading">Information!</strong> This alert needs your attention, but its not important.
              </span>
            </Alert>
          </div>
          { /* END Example */}
        ...
        <Col lg={ 6 }>
          ...
          <div className="mb-4">
            ...
            <Alert color="warning">
              ...
              <span>
                <strong className="alert-heading">Warning!</strong> Better check yourself, youre not looking too good.
              </span>
            </Alert>
          </div>
          { /* END Example */}
          ...
          <div className="mb-4">
            ...
            <Alert color="dark">
              ...
              <span>
                <strong className="alert-heading">Attention!</strong> This alert needs your attention, but its not important.
              </span>
            </Alert> 
          </div>
          { /* END Example */}
