...
import { GET_ALL_PLUGIN_MENU } from '../actions/types'

import { getAllPluginResponse } from '../actions/PluginMenuActions'

import { fetchPluginList } from '../api/plugin-menu-api'
...
export default function* rootSaga() {
  yield all([fork(getPluginWatcher)])
}
