...
Requires:       openssl, httpd, mod_ssl, mod_auth_openidc, curl, wget, tar, xz, unzip, rsyslog, bzip2, postgresql, postgresql-contrib, postgresql-server, python-requests, python-ruamel-yaml, python-certifi, python-psycopg2
%description
