...
![Version: 5.0.16-dev](https://img.shields.io/badge/Version-5.0.16--dev-informational?style=flat-square) ![AppVersion: 5.0.0](https://img.shields.io/badge/AppVersion-5.0.0-informational?style=flat-square)
...
|------------|------|---------|
|  | admin-ui | 5.0.16-dev |
|  | auth-server | 5.0.16-dev |
|  | auth-server-key-rotation | 5.0.16-dev |
|  | casa | 5.0.16-dev |
|  | cn-istio-ingress | 5.0.16-dev |
|  | config | 5.0.16-dev |
|  | config-api | 5.0.16-dev |
|  | fido2 | 5.0.16-dev |
|  | nginx-ingress | 5.0.16-dev |
|  | opendj | 5.0.16-dev |
|  | oxpassport | 5.0.16-dev |
|  | oxshibboleth | 5.0.16-dev |
|  | persistence | 5.0.16-dev |
|  | scim | 5.0.16-dev |
...
| admin-ui.image.tag | string | `"1.0.12_dev"` | Image  tag to use for deploying. |
...
| auth-server-key-rotation.image.tag | string | `"1.0.12_dev"` | Image  tag to use for deploying. |
...
| auth-server.image.tag | string | `"1.0.12_dev"` | Image  tag to use for deploying. |
...
| config-api.image.tag | string | `"1.0.12_dev"` | Image  tag to use for deploying. |
...
| config.image.tag | string | `"1.0.12_dev"` | Image  tag to use for deploying. |
...
| fido2.image.tag | string | `"1.0.12_dev"` | Image  tag to use for deploying. |
...
| persistence | object | `{"additionalAnnotations":{},"additionalLabels":{},"dnsConfig":{},"dnsPolicy":"","image":{"pullPolicy":"IfNotPresent","pullSecrets":[],"repository":"ghcr.io/janssenproject/jans/persistence-loader","tag":"1.0.12_dev"},"lifecycle":{},"resources":{"limits":{"cpu":"300m","memory":"300Mi"},"requests":{"cpu":"300m","memory":"300Mi"}},"usrEnvs":{"normal":{},"secret":{}},"volumeMounts":[],"volumes":[]}` | Job to generate data and initial config for Gluu Server persistence layer. |
...
| persistence.image.tag | string | `"1.0.12_dev"` | Image  tag to use for deploying. |
...
| scim.image.tag | string | `"1.0.12_dev"` | Image  tag to use for deploying. |
