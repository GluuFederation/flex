...
![Version: 5.0.9](https://img.shields.io/badge/Version-5.0.9-informational?style=flat-square) ![AppVersion: 5.0.0](https://img.shields.io/badge/AppVersion-5.0.0-informational?style=flat-square)
...
|  | admin-ui | 5.0.9 |
|  | auth-server | 5.0.9 |
|  | auth-server-key-rotation | 5.0.9 |
|  | casa | 5.0.9 |
|  | cn-istio-ingress | 5.0.9 |
|  | config | 5.0.9 |
|  | config-api | 5.0.9 |
|  | fido2 | 5.0.9 |
|  | nginx-ingress | 5.0.9 |
...
| admin-ui.image.tag | string | `"1.0.4-1"` | Image  tag to use for deploying. |
...
| casa.image.tag | string | `"5.0.0-3"` | Image  tag to use for deploying. |
