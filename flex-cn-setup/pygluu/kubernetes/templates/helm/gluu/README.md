...
| admin-ui.image.tag | string | `"1.0.12-1"` | Image  tag to use for deploying. |
...
| auth-server-key-rotation.image.tag | string | `"1.0.12-1"` | Image  tag to use for deploying. |
...
| auth-server.image.tag | string | `"1.0.12-1"` | Image  tag to use for deploying. |
...
| casa.image.tag | string | `"5.0.0-12"` | Image  tag to use for deploying. |
...
| config-api.image.tag | string | `"1.0.12-1"` | Image  tag to use for deploying. |
...
| config.image.tag | string | `"1.0.12-1"` | Image  tag to use for deploying. |
...
| fido2.image.tag | string | `"1.0.12-1"` | Image  tag to use for deploying. |
...
| persistence | object | `{"additionalAnnotations":{},"additionalLabels":{},"dnsConfig":{},"dnsPolicy":"","image":{"pullPolicy":"IfNotPresent","pullSecrets":[],"repository":"ghcr.io/janssenproject/jans/persistence-loader","tag":"1.0.12-1"},"lifecycle":{},"resources":{"limits":{"cpu":"300m","memory":"300Mi"},"requests":{"cpu":"300m","memory":"300Mi"}},"usrEnvs":{"normal":{},"secret":{}},"volumeMounts":[],"volumes":[]}` | Job to generate data and initial config for Gluu Server persistence layer. |
...
| persistence.image.tag | string | `"1.0.12-1"` | Image  tag to use for deploying. |
...
| scim.image.tag | string | `"1.0.12-1"` | Image  tag to use for deploying. |
