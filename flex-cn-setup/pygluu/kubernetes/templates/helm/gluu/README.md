...
| auth-server-key-rotation.image.tag | string | `"1.0.2-1"` | Image  tag to use for deploying. |
...
| auth-server.image.tag | string | `"1.0.2-1"` | Image  tag to use for deploying. |
...
| client-api.image.tag | string | `"1.0.2-1"` | Image  tag to use for deploying. |
...
| config-api.image.tag | string | `"1.0.2-1"` | Image  tag to use for deploying. |
...
| config.configmap.cnClientApiCertCn | string | `"client-api"` | Client-api OAuth certificate common name. This should be left to the default value client-api. |
...
| config.image.tag | string | `"1.0.2-1"` | Image  tag to use for deploying. |
...
| fido2.image.tag | string | `"1.0.2-1"` | Image  tag to use for deploying. |
...
| global.client-api.appLoggers | object | `{"clientApiLogLevel":"INFO","clientApiLogTarget":"STDOUT","ldapStatsLogLevel":"INFO","ldapStatsLogTarget":"FILE","persistenceDurationLogLevel":"INFO","persistenceDurationLogTarget":"FILE","persistenceLogLevel":"INFO","persistenceLogTarget":"FILE","scriptLogLevel":"INFO","scriptLogTarget":"FILE"}` | App loggers can be configured to define where the logs will be redirected to and the level of each in which it should be displayed. |
...
| global.client-api.appLoggers.ldapStatsLogLevel | string | `"INFO"` | client-api_persistence_ldap_statistics.log level |
| global.client-api.appLoggers.ldapStatsLogTarget | string | `"FILE"` | client-api_persistence_ldap_statistics.log target |
| global.client-api.appLoggers.persistenceDurationLogLevel | string | `"INFO"` | client-api_persistence_duration.log level |
| global.client-api.appLoggers.persistenceDurationLogTarget | string | `"FILE"` | client-api_persistence_duration.log target |
| global.client-api.appLoggers.persistenceLogLevel | string | `"INFO"` | client-api_persistence.log level |
| global.client-api.appLoggers.persistenceLogTarget | string | `"FILE"` | client-api_persistence.log target |
| global.client-api.appLoggers.scriptLogLevel | string | `"INFO"` | client-api_script.log level |
| global.client-api.appLoggers.scriptLogTarget | string | `"FILE"` | client-api_script.log target |
...
| persistence | object | `{"additionalAnnotations":{},"additionalLabels":{},"dnsConfig":{},"dnsPolicy":"","image":{"pullPolicy":"IfNotPresent","pullSecrets":[],"repository":"janssenproject/persistence-loader","tag":"1.0.2-1"},"resources":{"limits":{"cpu":"300m","memory":"300Mi"},"requests":{"cpu":"300m","memory":"300Mi"}},"usrEnvs":{"normal":{},"secret":{}},"volumeMounts":[],"volumes":[]}` | Job to generate data and initial config for Gluu Server persistence layer. |
...
| persistence.image.tag | string | `"1.0.2-1"` | Image  tag to use for deploying. |
...
| scim.image.tag | string | `"1.0.2-1"` | Image  tag to use for deploying. |
