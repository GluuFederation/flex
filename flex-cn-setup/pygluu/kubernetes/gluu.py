...
class Gluu(object):
    ...
    def upgrade_gluu(self):
        ...
        values_file_parser["cnPersistenceHybridMapping"] = self.settings.get("global.cnPersistenceType")
        values_file_parser["cnPersistenceType"] = self.settings.get("config.configmap.cnPersistenceHybridMapping")
