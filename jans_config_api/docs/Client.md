...
**trustedClient** | **Boolean** | Attribute which corresponds to the \&quot;Pre-Authorization\&quot; property. Default value is false. | [optional] [default to false]
...
**includeClaimsInIdToken** | **Boolean** | If true then claims are included in token id, default value is false. | [default to false]
...
**disabled** | **Boolean** | Specifies whether client is disabled. | [optional] [default to false]
