...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new JansConfigApi.CacheConfigurationMemcachedApi();
  });
  ...
  describe('CacheConfigurationMemcachedApi', function() {
    describe('getConfigCacheMemcached', function() {
      it('should call getConfigCacheMemcached successfully', function(done) {
        //uncomment below and update the code to test getConfigCacheMemcached
        //instance.getConfigCacheMemcached(function(error) {
    ...
    describe('putConfigCacheMemcached', function() {
      it('should call putConfigCacheMemcached successfully', function(done) {
        ...
        //instance.putConfigCacheMemcached(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
