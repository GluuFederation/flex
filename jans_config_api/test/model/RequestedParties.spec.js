...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new JansConfigApi.RequestedParties();
  });
  ...
  describe('RequestedParties', function() {
    it('should create an instance of RequestedParties', function() {
      // uncomment below and update the code to test RequestedParties
      //var instane = new JansConfigApi.RequestedParties();
      //expect(instance).to.be.a(JansConfigApi.RequestedParties);
    });
