...
(function(root, factory) {
  ...
  describe('GluuAttribute', function() {
    ...
    it('should have the property oxAuthClaimName (base name: "oxAuthClaimName")', function() {
      // uncomment below and update the code to test the property oxAuthClaimName
      //var instane = new JansConfigApi.GluuAttribute();
      //expect(instance).to.be();
    });
    ...
    it('should have the property oxSCIMCustomAttribute (base name: "oxSCIMCustomAttribute")', function() {
      // uncomment below and update the code to test the property oxSCIMCustomAttribute
      //var instane = new JansConfigApi.GluuAttribute();
      //expect(instance).to.be();
    });
