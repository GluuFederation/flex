...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new JansConfigApi.OpenIDConnectClientDetails();
  });
  ...
  describe('OpenIDConnectClientDetails', function() {
    it('should create an instance of OpenIDConnectClientDetails', function() {
      // uncomment below and update the code to test OpenIDConnectClientDetails
      //var instane = new JansConfigApi.OpenIDConnectClientDetails();
      //expect(instance).to.be.a(JansConfigApi.OpenIDConnectClientDetails);
    });
