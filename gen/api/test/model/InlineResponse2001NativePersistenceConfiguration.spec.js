...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new JansConfigApi.InlineResponse2001NativePersistenceConfiguration();
  });
  ...
  describe('InlineResponse2001NativePersistenceConfiguration', function() {
    it('should create an instance of InlineResponse2001NativePersistenceConfiguration', function() {
      // uncomment below and update the code to test InlineResponse2001NativePersistenceConfiguration
      //var instane = new JansConfigApi.InlineResponse2001NativePersistenceConfiguration();
      //expect(instance).to.be.a(JansConfigApi.InlineResponse2001NativePersistenceConfiguration);
    });
