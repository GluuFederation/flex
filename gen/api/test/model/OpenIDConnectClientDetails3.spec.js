...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new JansConfigApi.OpenIDConnectClientDetails3();
  });
  ...
  describe('OpenIDConnectClientDetails3', function() {
    it('should create an instance of OpenIDConnectClientDetails3', function() {
      // uncomment below and update the code to test OpenIDConnectClientDetails3
      //var instane = new JansConfigApi.OpenIDConnectClientDetails3();
      //expect(instance).to.be.a(JansConfigApi.OpenIDConnectClientDetails3);
    });
