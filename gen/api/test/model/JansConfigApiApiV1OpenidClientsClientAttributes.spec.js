...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new JansConfigApi.JansConfigApiApiV1OpenidClientsClientAttributes();
  });
  ...
  describe('JansConfigApiApiV1OpenidClientsClientAttributes', function() {
    it('should create an instance of JansConfigApiApiV1OpenidClientsClientAttributes', function() {
      // uncomment below and update the code to test JansConfigApiApiV1OpenidClientsClientAttributes
      //var instane = new JansConfigApi.JansConfigApiApiV1OpenidClientsClientAttributes();
      //expect(instance).to.be.a(JansConfigApi.JansConfigApiApiV1OpenidClientsClientAttributes);
    });
