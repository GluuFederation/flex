...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new JansConfigApi.ScopeAttributes();
  });
  ...
  describe('ScopeAttributes', function() {
    it('should create an instance of ScopeAttributes', function() {
      // uncomment below and update the code to test ScopeAttributes
      //var instane = new JansConfigApi.ScopeAttributes();
      //expect(instance).to.be.a(JansConfigApi.ScopeAttributes);
    });
