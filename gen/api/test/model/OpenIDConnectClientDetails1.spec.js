...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new JansConfigApi.OpenIDConnectClientDetails1();
  });
  ...
  describe('OpenIDConnectClientDetails1', function() {
    it('should create an instance of OpenIDConnectClientDetails1', function() {
      // uncomment below and update the code to test OpenIDConnectClientDetails1
      //var instane = new JansConfigApi.OpenIDConnectClientDetails1();
      //expect(instance).to.be.a(JansConfigApi.OpenIDConnectClientDetails1);
    });
