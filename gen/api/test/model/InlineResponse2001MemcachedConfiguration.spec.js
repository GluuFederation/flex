...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new JansConfigApi.InlineResponse2001MemcachedConfiguration();
  });
  ...
  describe('InlineResponse2001MemcachedConfiguration', function() {
    it('should create an instance of InlineResponse2001MemcachedConfiguration', function() {
      // uncomment below and update the code to test InlineResponse2001MemcachedConfiguration
      //var instane = new JansConfigApi.InlineResponse2001MemcachedConfiguration();
      //expect(instance).to.be.a(JansConfigApi.InlineResponse2001MemcachedConfiguration);
    });
    ...
    it('should have the property memcachedConnectionFactoryType (base name: "memcachedConnectionFactoryType")', function() {
      // uncomment below and update the code to test the property memcachedConnectionFactoryType
      //var instane = new JansConfigApi.InlineResponse2001MemcachedConfiguration();
      //expect(instance).to.be();
    });
