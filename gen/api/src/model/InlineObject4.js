 ...
 * @member {String} host
 */
InlineObject4.prototype['host'] = undefined;

/**
 * Port number of the SMTP server.
 * @member {Number} port
 */
InlineObject4.prototype['port'] = undefined;

/**
 * Boolean value with default value false. If true, SSL will be enabled.
 * @member {Boolean} requires-ssl
 */
InlineObject4.prototype['requires-ssl'] = undefined;

/**
 * Boolean value with default value false.
 * @member {Boolean} trust-host
 */
InlineObject4.prototype['trust-host'] = undefined;

/**
 * Name of the sender.
 * @member {String} from-name
 */
InlineObject4.prototype['from-name'] = undefined;

/**
 * Email Address of the Sender.
 * @member {String} from-email-address
 */
InlineObject4.prototype['from-email-address'] = undefined;
 ...
 */
InlineObject4.prototype['requires-authentication'] = undefined;

/**
 * Username of the SMTP.
 * @member {String} user-name
 */
InlineObject4.prototype['user-name'] = undefined;
