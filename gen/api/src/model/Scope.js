...
class Scope {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('oxAuthClaims')) {
                obj['oxAuthClaims'] = ApiClient.convertToType(data['oxAuthClaims'], ['String']);
            }
 ...
 * @member {Array.<String>} oxAuthClaims
 */
Scope.prototype['oxAuthClaims'] = undefined;
