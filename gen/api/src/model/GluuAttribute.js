...
class GluuAttribute {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('oxAuthClaimName')) {
                obj['oxAuthClaimName'] = ApiClient.convertToType(data['oxAuthClaimName'], 'String');
            }
            ...
            if (data.hasOwnProperty('oxSCIMCustomAttribute')) {
                obj['oxSCIMCustomAttribute'] = ApiClient.convertToType(data['oxSCIMCustomAttribute'], 'Boolean');
            }
...
/**
 * @member {String} oxAuthClaimName
 */
GluuAttribute.prototype['oxAuthClaimName'] = undefined;
 ...
 * @member {Boolean} oxSCIMCustomAttribute
 */
GluuAttribute.prototype['oxSCIMCustomAttribute'] = undefined;
