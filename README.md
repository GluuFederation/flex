...
Flex is built on Janssen Project components, so configurations are portable
between the commercial Flex and the open-source Janssen distributions — see
the [Gluu documentation](https://docs.gluu.org/stable/) for details.
...
[documentation](https://docs.gluu.org/stable/admin/admin-ui/introduction/).
...
![Admin UI dashboard](./docs/assets/admin-ui/dashboard.png)
...
![Admin UI left navigation bar](./docs/assets/admin-ui/left-nav-bar.png)
...
![Monthly Active Users monitoring](./docs/assets/admin-ui/mau.png)
