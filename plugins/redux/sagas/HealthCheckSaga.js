...
import { GET_HEALTH_CHECK } from '../types'

import { getHealthCheckResponse } from '../actions/HealthCheckActions'

import { fetchHealthCheckComponents } from '../api/health-check'
...
export default function* rootSaga() {
  yield all([fork(getHealthCheckWorker)])
}
