export const config = {
  roles: [
    { role: 'api-viewer', description: '' },
    { role: 'api-editor', description: '' },
    { role: 'api-manager', description: '' },
    { role: 'api-admin', description: '' },
  ],
  permissions: [
    {
    ...
    { permission: 'jans_stat', description: null },
  ],
  rolePermissionMapping: [
    ...
    },
    {
      ...
      permissions: [
        ...
        'https://jans.io/oauth/config/stats.readonly',
        'jans_stat',
        'https://jans.io/adminui/user/permissions.read',
        'https://jans.io/adminui/user/permissions.write',
      ],
    },
  ],
}
