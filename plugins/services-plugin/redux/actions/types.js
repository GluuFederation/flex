...
export const GET_SQL_RESPONSE = 'GET_SQL_RESPONSE'
export const SET_SQL = 'SET_SQL'
export const SET_SQL_RESPONSE = 'SET_SQL_RESPONSE'
export const PUT_SQL = 'PUT_SQL'
export const PUT_SQL_RESPONSE = 'PUT_SQL_RESPONSE'
export const DELETE_SQL = 'DELETE_SQL'
export const DELETE_SQL_RESPONSE = 'DELETE_SQL_RESPONSE'
export const TEST_SQL = 'TEST_SQL'
export const TEST_SQL_RESPONSE = 'TEST_SQL_RESPONSE'
export const ADD_SQL = 'ADD_SQL'
export const ADD_SQL_RESPONSE = 'ADD_SQL_RESPONSE'
// Persistence Type
export const GET_PERSISTENCE_TYPE = 'GET_PERSISTENCE_TYPE'
export const GET_PERSISTENCE_TYPE_RESPONSE = 'GET_PERSISTENCE_TYPE_RESPONSE'
//cache
