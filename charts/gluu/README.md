...
![Version: 5.0.26-dev](https://img.shields.io/badge/Version-5.0.26--dev-informational?style=flat-square) ![AppVersion: 5.0.23-dev](https://img.shields.io/badge/AppVersion-5.0.23--dev-informational?style=flat-square)
...
|------------|------|---------|
|  | admin-ui | 5.0.26-dev |
|  | auth-server | 5.0.26-dev |
|  | auth-server-key-rotation | 5.0.26-dev |
|  | casa | 5.0.26-dev |
|  | cn-istio-ingress | 5.0.26-dev |
|  | config | 5.0.26-dev |
|  | config-api | 5.0.26-dev |
|  | fido2 | 5.0.26-dev |
|  | link | 5.0.26-dev |
|  | nginx-ingress | 5.0.26-dev |
|  | opendj | 5.0.26-dev |
|  | persistence | 5.0.26-dev |
|  | saml | 5.0.26-dev |
|  | scim | 5.0.26-dev |
...
| admin-ui.image.tag | string | `"1.0.23-SNAPSHOT_dev"` | Image  tag to use for deploying. |
...
| auth-server-key-rotation.image.tag | string | `"1.0.23-SNAPSHOT_dev"` | Image  tag to use for deploying. |
...
| auth-server.image.tag | string | `"1.0.23-SNAPSHOT_dev"` | Image  tag to use for deploying. |
...
| casa.image.tag | string | `"1.0.23-SNAPSHOT_dev"` | Image  tag to use for deploying. |
...
| config-api.image.tag | string | `"1.0.23-SNAPSHOT_dev"` | Image  tag to use for deploying. |
...
| config.image.tag | string | `"1.0.23-SNAPSHOT_dev"` | Image  tag to use for deploying. |
...
| fido2.image.tag | string | `"1.0.23-SNAPSHOT_dev"` | Image  tag to use for deploying. |
...
| link.image.tag | string | `"1.0.23-SNAPSHOT_dev"` | Image  tag to use for deploying. |
...
| persistence | object | `{"additionalAnnotations":{},"additionalLabels":{},"customScripts":[],"dnsConfig":{},"dnsPolicy":"","image":{"pullPolicy":"IfNotPresent","pullSecrets":[],"repository":"ghcr.io/janssenproject/jans/persistence-loader","tag":"1.0.23-SNAPSHOT_dev"},"lifecycle":{},"resources":{"limits":{"cpu":"300m","memory":"300Mi"},"requests":{"cpu":"300m","memory":"300Mi"}},"usrEnvs":{"normal":{},"secret":{}},"volumeMounts":[],"volumes":[]}` | Job to generate data and initial config for Gluu Server persistence layer. |
...
| persistence.image.tag | string | `"1.0.23-SNAPSHOT_dev"` | Image  tag to use for deploying. |
...
| saml.image.tag | string | `"1.0.23-SNAPSHOT_dev"` | Image  tag to use for deploying. |
...
| scim.image.tag | string | `"1.0.23-SNAPSHOT_dev"` | Image  tag to use for deploying. |
