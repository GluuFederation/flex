...
|  | casa | 1.1.4-dev |
|  | cn-istio-ingress | 5.1.4-dev |
|  | config | 1.1.4-dev |
|  | config-api | 1.1.4-dev |
|  | fido2 | 1.1.4-dev |
|  | kc-scheduler | 1.1.4-dev |
|  | link | 1.1.4-dev |
|  | nginx-ingress | 5.1.4-dev |
|  | opendj | 5.1.4-dev |
...
| admin-ui.image.tag | string | `"5.1.4_dev"` | Image  tag to use for deploying. |
