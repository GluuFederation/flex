...
| admin-ui.image.tag | string | `"0.0.0-nightly"` | Image  tag to use for deploying. |
...
| cleanup | object | `{"additionalAnnotations":{},"additionalLabels":{},"customCommand":[],"customScripts":[],"dnsConfig":{},"dnsPolicy":"","image":{"pullPolicy":"IfNotPresent","pullSecrets":[],"repository":"ghcr.io/janssenproject/jans/cloudtools","tag":"0.0.0-nightly"},"interval":60,"lifecycle":{},"limit":1000,"nodeSelector":{},"resources":{"limits":{"cpu":"300m","memory":"300Mi"},"requests":{"cpu":"300m","memory":"300Mi"}},"tolerations":[],"usrEnvs":{"normal":{},"secret":{}},"volumeMounts":[],"volumes":[]}` | Cleanup expired entries in persistence |
...
| global.admin-ui.gatewayName | string | `""` | Override Gateway name for Gateway API (defaults to gateway-api.gateway.name) |
| global.admin-ui.gatewayNamespace | string | `""` | Override Gateway namespace for Gateway API (defaults to gateway-api.routes.gatewayNamespace or release namespace) |
...
| global.auth-server.gatewayName | string | `""` | Override Gateway name for Gateway API (defaults to gateway-api.gateway.name) |
| global.auth-server.gatewayNamespace | string | `""` | Override Gateway namespace for Gateway API (defaults to gateway-api.routes.gatewayNamespace or release namespace) |
...
| global.casa.gatewayName | string | `""` | Override Gateway name for Gateway API (defaults to gateway-api.gateway.name) |
| global.casa.gatewayNamespace | string | `""` | Override Gateway namespace for Gateway API (defaults to gateway-api.routes.gatewayNamespace or release namespace) |
...
| global.config-api.gatewayName | string | `""` | Override Gateway name for Gateway API (defaults to gateway-api.gateway.name) |
| global.config-api.gatewayNamespace | string | `""` | Override Gateway namespace for Gateway API (defaults to gateway-api.routes.gatewayNamespace or release namespace) |
...
| global.fido2.gatewayName | string | `""` | Override Gateway name for Gateway API (defaults to gateway-api.gateway.name) |
| global.fido2.gatewayNamespace | string | `""` | Override Gateway namespace for Gateway API (defaults to gateway-api.routes.gatewayNamespace or release namespace) |
...
| global.scim.gatewayName | string | `""` | Override Gateway name for Gateway API (defaults to gateway-api.gateway.name) |
| global.scim.gatewayNamespace | string | `""` | Override Gateway namespace for Gateway API (defaults to gateway-api.routes.gatewayNamespace or release namespace) |
...
| persistence | object | `{"additionalAnnotations":{},"additionalLabels":{},"customCommand":[],"customScripts":[],"dnsConfig":{},"dnsPolicy":"","image":{"pullPolicy":"IfNotPresent","pullSecrets":[],"repository":"ghcr.io/gluufederation/flex/persistence-loader","tag":"0.0.0-nightly"},"lifecycle":{},"nodeSelector":{},"resources":{"limits":{"cpu":"300m","memory":"300Mi"},"requests":{"cpu":"300m","memory":"300Mi"}},"tolerations":[],"usrEnvs":{"normal":{},"secret":{}},"volumeMounts":[],"volumes":[]}` | Job to generate data and initial config for Gluu Server persistence layer. |
