...
|------------|------|---------|
|  | admin-ui | 5.1.5-dev |
|  | auth-server | 1.1.5-dev |
|  | auth-server-key-rotation | 1.1.5-dev |
|  | casa | 1.1.5-dev |
|  | cn-istio-ingress | 5.1.5-dev |
|  | config | 1.1.5-dev |
|  | config-api | 1.1.5-dev |
|  | fido2 | 1.1.5-dev |
|  | kc-scheduler | 1.1.5-dev |
|  | link | 1.1.5-dev |
|  | nginx-ingress | 5.1.5-dev |
|  | opendj | 5.1.5-dev |
|  | persistence | 1.1.5-dev |
|  | saml | 1.1.5-dev |
|  | scim | 1.1.5-dev |
...
| admin-ui.image.tag | string | `"5.1.5_dev"` | Image  tag to use for deploying. |
...
| auth-server.image.tag | string | `"1.1.5_dev"` | Image  tag to use for deploying. |
...
| casa.image.tag | string | `"1.1.5_dev"` | Image  tag to use for deploying. |
...
| config-api.image.tag | string | `"1.1.5_dev"` | Image  tag to use for deploying. |
...
| config.image.tag | string | `"1.1.5_dev"` | Image  tag to use for deploying. |
...
| fido2.image.tag | string | `"1.1.5_dev"` | Image  tag to use for deploying. |
...
| kc-scheduler | object | `{"additionalAnnotations":{},"additionalLabels":{},"customScripts":[],"dnsConfig":{},"dnsPolicy":"","image":{"pullPolicy":"IfNotPresent","pullSecrets":[],"repository":"ghcr.io/janssenproject/jans/kc-scheduler","tag":"1.1.5_dev"},"interval":10,"lifecycle":{},"resources":{"limits":{"cpu":"300m","memory":"300Mi"},"requests":{"cpu":"300m","memory":"300Mi"}},"usrEnvs":{"normal":{},"secret":{}},"volumeMounts":[],"volumes":[]}` | Responsible for synchronizing Keycloak SAML clients |
...
| link.image.tag | string | `"1.1.5_dev"` | Image  tag to use for deploying. |
...
| persistence | object | `{"additionalAnnotations":{},"additionalLabels":{},"customScripts":[],"dnsConfig":{},"dnsPolicy":"","image":{"pullPolicy":"IfNotPresent","pullSecrets":[],"repository":"ghcr.io/janssenproject/jans/persistence-loader","tag":"1.1.5_dev"},"lifecycle":{},"resources":{"limits":{"cpu":"300m","memory":"300Mi"},"requests":{"cpu":"300m","memory":"300Mi"}},"usrEnvs":{"normal":{},"secret":{}},"volumeMounts":[],"volumes":[]}` | Job to generate data and initial config for Gluu Server persistence layer. |
...
| persistence.image.tag | string | `"1.1.5_dev"` | Image  tag to use for deploying. |
...
| saml.image.tag | string | `"1.1.5_dev"` | Image  tag to use for deploying. |
...
| scim.image.tag | string | `"1.1.5_dev"` | Image  tag to use for deploying. |
