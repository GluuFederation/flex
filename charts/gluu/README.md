...
| admin-ui.image.tag | string | `"1.1.0_dev"` | Image  tag to use for deploying. |
...
| config.configmap.cnVaultCACertFile | string | `"/etc/certs/vault_ca.crt"` | Path to Vault CA cert file. |
| config.configmap.cnVaultCertFile | string | `"/etc/certs/vault_client.crt"` | Path to Vault client cert file. |
| config.configmap.cnVaultKeyFile | string | `"/etc/certs/vault_client.key"` | Path to Vault client key file. |
