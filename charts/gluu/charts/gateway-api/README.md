...
|-----|------|---------|-------------|
| additionalConfig | object | `{"airlock":{"createLbService":false},"cilium":{"ipPoolBlocks":[]},"envoy":{"createGatewayClass":false},"istio":{},"kgateway":{},"nginx":{"enableClientCertSnippets":false},"traefik":{}}` | Additional configuration for Specific Gateway API implementation |
...
| additionalConfig.nginx | object | `{"enableClientCertSnippets":false}` | Configuration for NGINX Fabric. |
...
| gateway | object | `{"annotations":{},"attachLbIp":false,"caCert":"","className":"nginx","httpPort":80,"httpsPort":443,"infrastructure":{"annotations":{},"labels":{},"parametersRef":{}},"labels":{},"name":"gluu-gateway","tlsSecretName":"tls-certificate","verifyClientCertProtection":false}` | Configuration for Gateway resource |
