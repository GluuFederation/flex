...
![Version: 5.1.2-dev](https://img.shields.io/badge/Version-5.1.1--dev-informational?style=flat-square) ![AppVersion: 5.1.1](https://img.shields.io/badge/AppVersion-5.1.1-informational?style=flat-square)
...
|------------|------|---------|
|  | admin-ui | 5.1.2-dev |
|  | auth-server | 1.1.2-dev |
|  | auth-server-key-rotation | 1.1.2-dev |
|  | casa | 1.1.2-dev |
|  | cn-istio-ingress | 5.1.2-dev |
|  | config | 1.1.2-dev |
|  | config-api | 1.1.2-dev |
|  | fido2 | 1.1.2-dev |
|  | link | 1.1.2-dev |
|  | nginx-ingress | 5.1.2-dev |
|  | opendj | 5.1.2-dev |
|  | persistence | 1.1.2-dev |
|  | saml | 1.1.2-dev |
|  | scim | 1.1.2-dev |
...
| admin-ui.image.tag | string | `"5.1.2_dev"` | Image  tag to use for deploying. |
...
| auth-server.image.tag | string | `"1.1.2_dev"` | Image  tag to use for deploying. |
...
| casa.image.tag | string | `"1.1.2_dev"` | Image  tag to use for deploying. |
...
| config-api.image.tag | string | `"1.1.2_dev"` | Image  tag to use for deploying. |
...
| config.image.tag | string | `"1.1.2_dev"` | Image  tag to use for deploying. |
...
| fido2.image.tag | string | `"1.1.2_dev"` | Image  tag to use for deploying. |
...
| link.image.tag | string | `"1.1.2_dev"` | Image  tag to use for deploying. |
...
| persistence | object | `{"additionalAnnotations":{},"additionalLabels":{},"customScripts":[],"dnsConfig":{},"dnsPolicy":"","image":{"pullPolicy":"IfNotPresent","pullSecrets":[],"repository":"ghcr.io/janssenproject/jans/persistence-loader","tag":"1.1.2_dev"},"lifecycle":{},"resources":{"limits":{"cpu":"300m","memory":"300Mi"},"requests":{"cpu":"300m","memory":"300Mi"}},"usrEnvs":{"normal":{},"secret":{}},"volumeMounts":[],"volumes":[]}` | Job to generate data and initial config for Gluu Server persistence layer. |
...
| persistence.image.tag | string | `"1.1.2_dev"` | Image  tag to use for deploying. |
...
| saml.image.tag | string | `"1.1.2_dev"` | Image  tag to use for deploying. |
...
| scim.image.tag | string | `"1.1.2_dev"` | Image  tag to use for deploying. |
