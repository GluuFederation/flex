...
![version: 5.1.4-dev](https://img.shields.io/badge/Version-5.1.3--dev-informational?style=flat-square) ![Appversion: 5.1.4-dev](https://img.shields.io/badge/AppVersion-5.1.3--dev-informational?style=flat-square)
...
| link.image.tag | string | `"1.1.4_dev"` | Image  tag to use for deploying. |
