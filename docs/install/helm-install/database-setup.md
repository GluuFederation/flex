...
Flex requires a database for persistence storage. Choose between PostgreSQL(recommended) or MySQL.
...
Proceed to [Install Flex](install-flex.md) to deploy the Helm chart.
