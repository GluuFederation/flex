...
Gluu Flex Admin UI facilitates interaction with the Jans Auth Server through a REST API layer, i.e. Jans Config-API. This error prompts administrators to perform a series of troubleshooting steps.
